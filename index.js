...
//                       ]) ]);
const h1 = React.createElement("h1",{id:"childInside1"},"Hello friends i am after before  after afterkishan");
const h2 = React.createElement("h1",{id:"childInside2"},"Hello i am the after before after theeeeeeeeeee Billionaire");
const h3 = React.createElement("h1",{id:"childInside3"},"Hiiiii friends i am after before after kishan");
const h4 = React.createElement("h1",{id:"childInside4"},"Hiiiii i am after  before  after it");
