...
//                       ]) ]);
const h1 = React.createElement("h1",{id:"childInside1"},"Hello friends i am before kishan");
const h2 = React.createElement("h1",{id:"childInside2"},"Hello i am the before theeeeeeeeeee Billionaire");
const h3 = React.createElement("h1",{id:"childInside3"},"Hiiiii friends i am beforekishan");
const h4 = React.createElement("h1",{id:"childInside4"},"Hiiiii i am before it");
